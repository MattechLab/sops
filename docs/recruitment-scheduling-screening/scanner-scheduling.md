The acquisition day was defined based on the availability of the participant and the availability of the PrismaFit system. The PrismaFit system is then booked following these steps:
